const Footer = () => {
    ...
    return (
        <footer className="bg-white dark:bg-first-950 ">
            <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 border-t">
                <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="sm:col-span-2">
                        ...
                        >
              <span className="ml-2 text-2xl font-bold tracking-wide text-first-800 dark:text-white">
                Medinchina
              </span>
                            <h6 className="dark:text-third-500">AGENCE</h6>
                        </a>
